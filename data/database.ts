...
import { AccountRecovery, AccountRecoveryDAO } from './models/account-recovery.model';
...
export class Database {
  ...
  public Build() {
    ...
    ParkingDAO.hasMany(ParkingFile, { foreignKey: 'parkingId', as: 'files' });
    ...
    ParkingDAO.hasOne(ParkingAddress, { foreignKey: 'parkingId', as: 'address' });
