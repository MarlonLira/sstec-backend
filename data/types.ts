const TYPES = {
  ...
  ISchedulingServiceService: Symbol('ISchedulingServiceService'),
  ...
  IParkingServiceRepository: Symbol('IParkingServiceRepository'),
  ...
  ISchedulingServiceRepository: Symbol('ISchedulingServiceRepository'),
